...
<body>
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <!-- Contenido Principal -->
      <div class="col-lg-10 min-vh-100">
        <br>
  ...
  <div id="modal1" class="modal">
    <div class="modal-content">
      <div class="modal-body-content">
        ...
        <p>Objetivo: Reconocer la utilidad y pertinencia de diversas<br />herramientas didácticas aplicables a la
...
document.getElementById('deleteActivityImage').addEventListener('click', function() {
  Swal.fire({
    ...
    text: "Curso excel?", //aqui debe de ir lo dinamico de cada act
    icon: "warning",
    ...
    if (result.isConfirmed) {
      ...
      // Por ejemplo, una llamada a la API o eliminar el elemento del DOM
      ...
      // Cerrar el modal después de eliminar la actividad
      closeModal('modal3');
    }
  });
});
...
// Ejemplo de cómo abrir el modal (puedes conectarlo a algún botón o evento)
// showModal('modal3');
